    ...
    <el-card class="box-card" v-loading="store.state.progressing">
      <template #header>
        <div class="card-header flex justify-between items-center">
          <span>Result</span>
          <el-button v-if="store.state.show.create&&store.state.user.superUser" @click="store.dispatch('action', {type:'add', id:0})" :icon="Plus" type="primary" plain>Add角色</el-button>
        </div>
      </template>
...
import InfoForm from '../../components/role/InfoForm.vue'
