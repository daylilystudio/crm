<template>
      ...
      <el-form :rules="rules" :model="filterForm" label-position="left">
        <div class="grid sm:gap-x-8 sm:grid-cols-2">
          ...
          <el-form-item label="聯絡人" prop="name">
            <el-input v-model="filterForm.name" placeholder="輸入姓名" clearable />
          </el-form-item>
          <el-form-item label="電話" prop="phone">
            <el-input v-model="filterForm.phone" placeholder="輸入電話" clearable />
          </el-form-item>
  ...
  <el-dialog v-model="statusModalOpen" title="變更案件狀態" :append-to-body="true" :close-on-click-modal="false" width="95%" style="max-width: 460px;">
    ...
    <div class="text-right">
      <el-button @click="statusModalOpen=false">關閉</el-button>
      <el-button type="primary" @click="savaStatus()">儲存</el-button>
    </div>
  </el-dialog>
</template>
