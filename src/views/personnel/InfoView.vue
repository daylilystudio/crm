  ...
  <el-space :size="20" :fill="true" class="w-full px-4">
      ...
      <el-form label-position="left">
        <div class="grid sm:gap-x-8 sm:grid-cols-2">
          ...
          <el-form-item label="人員代號" prop="username">
            <el-input v-model="filterForm.username" placeholder="輸入人員代號" maxlength="50" clearable />
          </el-form-item>
          <el-form-item label="人員名稱" prop="name">
            <el-input v-model="filterForm.name" placeholder="輸入人員名稱" clearable />
          </el-form-item>
        </div>
    ...
    <el-card class="box-card" v-loading="store.state.progressing">
      ...
      <el-table :data="store.state.table" :flexible="true" border>
        ...
        <el-table-column prop="name" label="人員名稱" />
...
import InfoForm from '../../components/personnel/InfoForm.vue'
